namespace App1_Chat; //Cambiar a App2_Chat en el otro proyecto
...
public partial class SettingsPage : ContentPage
{
    ...
    private void LoadSettings()
    {
        ...
        EntColaPublish.Text = Preferences.Get("QueuePub", "cola1");
        EntColaConsume.Text = Preferences.Get("QueueSub", "cola2");
